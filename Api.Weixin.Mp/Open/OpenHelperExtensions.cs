...
namespace Api.Weixin.Mp.Open
{
    ...
    /// 
    /// </summary>
    public static class OpenHelperExtensions
    {
        ...
        /// <returns></returns>
        public static GetSNSAccessTokenResult GetSNSAccessToken(this ApiHelper helper, string appId, string appSecret, string code)
        {
        ...
        /// <returns></returns>
        public static RefreshSNSAccessTokenResult RefreshSNSAccessToken(this ApiHelper helper, string appid, string refresh_token)
        {
        ...
        /// <returns></returns>
        public static GetUserInfoResult GetSNSUserInfo(this ApiHelper helper, string access_token, string openId)
        {
        ...
        /// <returns></returns>
        public static GetComponentAccessTokenResult GetComponentAccessToken(this ApiHelper helper, string component_appid, string component_appsecret, string verify_ticket)
        {
        ...
        /// <param name="component_appid">第三方平台appid</param>
        /// <returns></returns>
        public static GetComponentPreAuthCodeResult GetComponentPreAuthCode(this ApiHelper helper, string component_access_token, string component_appid)
        {
        ...
        /// <returns></returns>
        public static QueryComponentAuthResult QueryComponentAuth(this ApiHelper helper, string component_access_token, string component_appid, string authorization_code)
        {
        ...
        /// <returns></returns>
        public static RefreshAuthorizerTokenResult RefreshAuthorizerToken(this ApiHelper helper, string component_access_token,
        ...
        /// <param name="authorizer_appid">授权方appid</param>
        /// <returns></returns>
        public static GetAuthorizerInfoResult GetAuthorizerInfo(this ApiHelper helper, string component_access_token,
        ...
        /// <returns></returns>
        public static GetAuthorizerOptionResult GetAuthorizerOption(this ApiHelper helper, string component_access_token,
        ...
        /// <param name="option_name">选项名称</param>
        /// <returns></returns>
        public static JsonResult SetAuthorizerOption(this ApiHelper helper, string component_access_token,
                string component_appid, string authorizer_appid, string option_name)
        {
            ...
            return HttpHelper.Send<dynamic, JsonResult>(url, new { component_appid = component_appid, authorizer_appid = authorizer_appid, option_name = option_name });
        }
    }
}
