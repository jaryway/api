...
namespace API.Mp
{
    ...
    public class MpHelper
    {
        ...
        private static volatile MpHelper _instance = null;
        ...
        /// </summary>
        /// <returns></returns>
        internal static MpHelper Instance()
        {
            if (_instance == null)
            {
                lock (lockObject)
        ...
        /// <returns></returns>
        public MpResult AddKFAccount(string access_token, string kf_account, string nickname, string password)
        {
            string url = string.Format("{0}customservice/kfaccount/add?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpPost.GetJsonResult<dynamic, MpResult>(url, new { kf_account = kf_account, nickname = nickname, password = password });
        }
        /// <summary>
        /// 修改客服帐号
        /// </summary>
        ...
        /// <param name="password">密码</param>
        /// <returns></returns>
        public MpResult UpdateKFAccount(string access_token, string kf_account, string nickname, string password)
        {
        ...
        /// <param name="password">密码</param>
        /// <returns></returns>
        public MpResult DeleteKFAccount(string access_token, string kf_account, string nickname, string password)
        {
        ...
        /// <returns></returns>
        public MpResult UploadHeadImg(string access_token, string kf_account, PostMedia media)
        {
            ...
            return JsonHelper.Decode<MpResult>(HttpHelper.HttpPost.GetMediaResult(url, media));
        }
        /// <summary>
        /// 获取所有客服账号
        /// </summary>
        ...
        /// <param name="access_token"></param>
        /// <returns></returns>
        public MpResult SendKFMessage(string access_token, SendKFMessageRequest request)
        {
            string url = string.Format("{0}cgi-bin/message/custom/send?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpPost.GetJsonResult<SendKFMessageRequest, MpResult>(url, request);
        }
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public MpResult UploadMediaNews(string access_token, UploadMediaNewsRequest request)
        {
            string url = string.Format("{0}cgi-bin/media/uploadnews?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpPost.GetJsonResult<UploadMediaNewsRequest, MpResult>(url, request);
        }
        /// <summary>
        ...
        /// <returns></returns>
        public MpResult DeleteMassMessage(string access_token, long msg_id)
        {
            string url = string.Format("{0}cgi-bin/message/mass/delete?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpPost.GetJsonResult<dynamic, MpResult>(url, new { msg_id = msg_id });
        }
        ...
        /// <param name="access_token"></param>
        /// <returns></returns>
        public MpResult SetIndustry(string access_token, int industry_id1, int industry_id2)
        {
            string url = string.Format("{0}cgi-bin/template/api_set_industry?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpPost.GetJsonResult<dynamic, MpResult>(url, new { industry_id1 = industry_id1, industry_id2 = industry_id2 });
        }
        ...
        /// <returns></returns>
        public MpResult UpdateGroup(string access_token, int id, string name)
        {
            string url = string.Format("{0}cgi-bin/groups/update?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpPost.GetJsonResult<dynamic, MpResult>(url, new { group = new { id = id, name = name } });
        }
        ...
        /// <returns></returns>
        public MpResult MoveMemberToGroup(string access_token, string openId, int to_groupid)
        {
            string url = string.Format("{0}cgi-bin/groups/members/update?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpPost.GetJsonResult<dynamic, MpResult>(url, new { openid = openId, to_groupid = to_groupid });
        }
        ...
        /// <param name="to_groupid">分组id</param>
        /// <returns></returns>
        public MpResult MoveMembersToGroup(string access_token, string[] openid_list, int to_groupid)
        {
            string url = string.Format("{0}cgi-bin/groups/members/batchupdate?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpPost.GetJsonResult<dynamic, MpResult>(url, new { openid_list = openid_list, to_groupid = to_groupid });
        }
        /// <summary>
        /// 删除分组
        /// </summary>
        ...
        /// <returns></returns>
        public MpResult DeleteGroup(string access_token, int groupid)
        {
            string url = string.Format("{0}cgi-bin/groups/delete?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpPost.GetJsonResult<dynamic, MpResult>(url, new { group = new { id = groupid } });
        }
        ...
        /// <returns></returns>
        public MpResult UpdateUserRemark(string access_token, string openid, string remark)
        {
            string url = string.Format("{0}cgi-bin/user/info/updateremark?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpPost.GetJsonResult<dynamic, MpResult>(url, new { openid = openid, remark = remark });
        }
        ...
        /// <returns></returns>
        public MpResult CreateCustomMenu(string access_token, string menuJsonData)
        {
            ...
            return JsonHelper.Decode<MpResult>(result);
        }
        ...
        /// <param name="access_token"></param>
        /// <returns></returns>
        public MpResult DeleteCustomMenu(string access_token)
        {
            string url = string.Format("{0}cgi-bin/menu/delete?access_token={1}", baseUrl, access_token);
            return HttpHelper.HttpGet.GetJsonResult<MpResult>(url);
        }
