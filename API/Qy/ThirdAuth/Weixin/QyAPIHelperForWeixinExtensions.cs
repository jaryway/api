...
namespace API.Qy.ThirdAuth.Weixin
{
    ...
    /// </summary>
    public static class QyAPIHelperForWeixinExtensions
    {
        ...
        /// <param name="suite_access_token"></param>
        /// <returns></returns>
        public static GetPermanentCodeResult GetPermanentCode(this IQyHelper helper, string suite_id, string auth_code, string suite_access_token)
        {
            var request = new GetPermanentCodeRequest { suite_id = suite_id, auth_code = auth_code };
            return helper.GetPermanentCode(request, suite_access_token);
        }
        /// <summary>
        /// 获取企业号的永久授权码
        /// 该API用于使用临时授权码换取授权方的永久授权码，并换取授权信息、企业access_token。
        ...
        /// <param name="suite_access_token"></param>
        /// <returns></returns>
        public static GetPermanentCodeResult GetPermanentCode(this IQyHelper helper, GetPermanentCodeRequest request, string suite_access_token)
        {
        ...
        /// <param name="suite_access_token"></param>
        /// <returns></returns>
        public static GetAuthInfoResult GetAuthInfo(this IQyHelper helper, GetAuthInfoRequest request, string suite_access_token)
        {
        ...
        /// <param name="suite_access_token"></param>
        /// <returns></returns>
        public static GetAgentResult GetAgent(this IQyHelper helper, string suite_id, string auth_corpid, string permanent_code,
            string agentid, string suite_access_token)
        {
            ...
            return helper.GetAgent(request, suite_access_token);
        }
        /// <summary>
        /// 获取企业号应用
        /// 该API用于获取授权方的企业号某个应用的基本信息，包括头像、昵称、帐号类型、认证类型、可见范围等信息
        ...
        /// <param name="suite_access_token"></param>
        /// <returns></returns>
        public static GetAgentResult GetAgent(this IQyHelper helper, GetAgentRequest request, string suite_access_token)
        {
        ...
        /// <param name="suite_access_token"></param>
        /// <returns></returns>
        public static SetAgentResult SetAgent(this IQyHelper helper, SetAgentRequest request, string suite_access_token)
        {
